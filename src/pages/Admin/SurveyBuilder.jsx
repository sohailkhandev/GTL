// the survey builder page is for admin to create survey
...
const SurveyBuilder = () => {
  ...
  // ✅ Save survey using SurveyContext
  const handleSaveSurvey = async () => {
    if (!editingSurvey) return;
    try {
      // Check if this survey already exists in the surveys array
      ...
      if (existingSurvey) {
        ...
        // This is a new survey, create it with the custom ID
  ...
  if (!user || user.type !== "admin") {
    return (
      <div className="max-w-4xl mx-auto py-8 text-center">
        ...
        <p>Please login with an admin account to access this feature.</p>
      </div>
    );
  }
      ...
      {!editingSurvey ? (
        <div>
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-medium">Existing Surveys</h3>
